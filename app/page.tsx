...
const PRODUCTS: Product[] = [
  {
    ...
    desc: 'Creamy, plant-based mayo crafted without eggs, gums, or artificial additives. Rich texture, authentic flavour.',
    from: '5.25',
  ...
  },
  {
    ...
    tag: 'Spicy',
    title: 'Chipotle Mayo',
    desc: 'Boldly flavorful with a smoky chipotle kick. Perfect for sandwiches, dips, and wraps.',
    from: '5.69',
  ...
  },
  {
    ...
    tag: 'New',
    title: 'CocoVida',
    desc: 'Indulgence without compromise. A rich chocolate spread for those who love flavour and read labels.',
    from: '7.00',
          ...
          <div>
            <div
              style={{
                ...
                fontSize: 9,
                letterSpacing: '.2em',
                color: hovered ? 'rgba(247,242,232,.4)' : 'rgba(30,58,47,.4)',
                marginBottom: 2,
                transition: 'color .4s',
              }}
            >
            ...
            >
              ${p.from}{' '}
              <span style={{ fontSize: 13, fontWeight: 400, fontFamily: "'DM Mono', monospace" }}>
                CAD
              </span>
            </div>
          </div>
    ...
    <main>
      ...
      <header role="banner">
        ...
        >
          ...
          <ul
            className="nav-links"
            role="list"
            style={{ display: 'flex', alignItems: 'center', gap: 36, listStyle: 'none', padding: 0 }}
          >
            {NAV_LINKS.map(([h, l]) => (
              <li key={h}>
                <a
      ...
      <div id="content">
        <section
          ...
          style={{
            minHeight: '100svh',
            background: 'linear-gradient(135deg,#F7F2E8 0%,#EDE5D0 60%,#E2D8C0 100%)',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
          <div
            ...
            style={{
              ...
              right: -150,
              borderRadius: '50%',
              border: '1px solid rgba(30,58,47,.05)',
              pointerEvents: 'none',
            }}
          />
          <div
            ...
            style={{
              ...
              right: -50,
              borderRadius: '50%',
              border: '1px solid rgba(184,147,58,.07)',
              pointerEvents: 'none',
            }}
          />
          <div
          ...
          >
            <div style={{ position: 'relative', zIndex: 2 }}>
              <div
                ...
                style={{
                  ...
                  animation: 'fadeUp .8s .1s cubic-bezier(.16,1,.3,1) forwards',
                }}
              >
              ...
              >
                Creamy,
                <br />
                <em style={{ fontStyle: 'italic', color: '#B8933A' }}>plant-based</em>
                <br />
                perfection.
              </h1>
              ...
              <p
                style={{
                  ...
                  opacity: 0,
                  transform: 'translateY(20px)',
                  animation: 'fadeUp .8s .35s cubic-bezier(.16,1,.3,1) forwards',
                }}
              >
                Crafted in Milton, Ontario with Burcon&apos;s revolutionary pea and canola protein
                isolates. Real flavour. Clean labels. Nothing hidden.
              </p>
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Shop spreads (opens in new tab)"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 10,
                ...
                <a
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: 10,
                    border: '1px solid rgba(30,58,47,.25)',
                    color: '#1E3A2F',
                    padding: '14px 28px',
                    fontFamily: 'DM Mono, monospace',
                    fontSize: 11,
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.background = 'rgba(30,58,47,.04)'
                  }}
                  onMouseLeave={(e) => {
              ...
              <ul
                ...
                style={{
                  ...
                  listStyle: 'none',
                  opacity: 0,
                  animation: 'fadeUp .8s .55s cubic-bezier(.16,1,.3,1) forwards',
                }}
              >
                {['🌱 Plant-Based', '🇨🇦 Made in Canada', '✨ Clean Label', '💪 Protein-Enhanced'].map(
                  (b) => (
                    <li
                      key={b}
                      style={{
            ...
            <div
              ...
              style={{
                ...
                zIndex: 2,
                opacity: 0,
                animation: 'fadeIn 1.1s .3s cubic-bezier(.16,1,.3,1) forwards',
              }}
            >
              <div style={{ position: 'relative', animation: 'floatY 6s ease-in-out infinite' }}>
                <img
                  ...
                  style={{
                    maxHeight: 560,
                    objectFit: 'contain',
                    filter: 'drop-shadow(0 40px 60px rgba(30,58,47,.18))',
                  }}
                />
                <div
                  style={{
                    ...
                    color: '#F7F2E8',
                    padding: '16px 24px',
                    boxShadow: '0 20px 40px rgba(30,58,47,.25)',
                  }}
                >
                  <div
                    style={{
        ...
        <section aria-label="Key statistics">
          <div className="four-col" style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', borderBottom: '1px solid #E2D8C0' }}>
            {[
              ...
              ['4', 'Signature Spreads'],
              ['Milton ON', 'Made in Canada'],
            ].map(([v, l], i) => (
              <Reveal key={l} delay={i * 80}>
                <div
                  style={{
                    padding: '52px 32px',
                    borderRight: i < 3 ? '1px solid #E2D8C0' : 'none',
                    textAlign: 'center',
                  }}
                >
                  <div
        ...
        <section
          ...
          className="sp"
          style={{ padding: '112px 48px', background: '#F7F2E8' }}
        >
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            <Reveal>
              <div style={{ textAlign: 'center', marginBottom: 64 }}>
                ...
                >
                  Every spread is made with Burcon&apos;s innovative protein blends — delivering real
                  creaminess, zero compromise.
                </p>
              </div>
            </Reveal>
            ...
            >
              {PRODUCTS.map((p, i) => (
                <ProductCard key={p.id} p={p} delay={i * 110} />
              ))}
            </div>
          ...
          >
            ...
            <Reveal dir="right" delay={150}>
              <div style={{ color: '#F7F2E8' }}>
                ...
                >
                  <p>
                    At Nature&apos;s Creamery, we believe treats should feel good during and after the
                    last spoonful. Our recipes are intentionally crafted using plant-based ingredients,
                    clean-label formulations, and protein-powered blends from Burcon NutraScience.
                  </p>
                  <p>
                    Think slow mornings, shared boards, and late-night snacks — all elevated with rich,
                    creamy textures and thoughtful nutrition.
                  </p>
                  <p>
                    Whether you&apos;re plant-curious or fully plant-based, our spreads fit beautifully
                    into a lifestyle that values nourishment, pleasure, and care for the planet.
                  </p>
                </div>

                <div role="list" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 40, padding: 0 }}>
                  {[
                    ['🌱', 'Plant-Based and Creamy', 'Never compromise on texture'],
                    ['💪', 'Protein-Enhanced', 'Innovative Burcon blends'],
                    ['🍞', 'Incredibly Versatile', 'Toast, boards, baking and more'],
                    ['📋', 'Clean Label', 'No gums, no additives'],
                  ].map(([icon, label, sub]) => (
                    <div
                      key={label}
                      role="listitem"
                    ...
                    >
                      <div aria-hidden="true" style={{ fontSize: 20, marginBottom: 8 }}>
                        {icon}
                      </div>
                      <div
                        style={{
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            <Reveal>
              <div style={{ textAlign: 'center', marginBottom: 64 }}>
                ...
                >
                  Burcon NutraScience&apos;s Peazazz C and Puratein C — pea and canola protein isolates
                  that give our spreads legendary creaminess without eggs or gums.
                </p>
              </div>
            </Reveal>
            ...
            <div className="three-col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 2, background: '#E2D8C0' }}>
              {[
                ...
                [
                  '03',
                  'Deliver',
                  'Bottled fresh in Milton, Ontario and ready for your fridge. Whether 354ml or 4L, every jar is made with the same care and precision.',
                ],
            ...
            <Reveal>
              <img
                ...
                style={{
                  width: '100%',
                  objectFit: 'contain',
                  filter: 'drop-shadow(0 40px 80px rgba(30,58,47,.15))',
            ...
            <Reveal dir="right" delay={200}>
              <div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Order now (opens in new tab)"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 10,
          ...
          >
            <Reveal dir="left">
              <div>
                ...
                >
                  Whether you&apos;re a retailer, chef, or passionate mayo lover — we&apos;d love to hear
                  from you. Visit us in Milton or drop us a line anytime.
                </p>
                ...
                <form onSubmit={submit} noValidate aria-label="Contact form">
                  {[
                    ...
                    <div key={f.id} style={{ marginBottom: 18 }}>
                      ...
                      >
                        {f.label}
                        {f.req && <span aria-label="required"> *</span>}
                      </label>
                      <input
                        id={`cf-${f.id}`}
                        type={f.type}
                        ...
                        onBlur={(e) => {
                          e.currentTarget.style.borderColor = 'rgba(247,242,232,.12)'
                        }}
                      />
                    </div>
                  ))}
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          <div
            style={{
              ...
              gap: 40,
              paddingBottom: 48,
              borderBottom: '1px solid rgba(247,242,232,.07)',
            }}
          >
            <div>
              <div
                ...
                {NAV_LINKS.map(([h, l]) => (
                  <li key={h}>
                    <a
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.color = '#D4AD59'
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.color = 'rgba(247,242,232,.4)'
                      }}
                    >
                      {l}
                    </a>
          ...
          >
            ...
            >
              {new Date().getFullYear()} Nature&apos;s Creamery. All rights reserved. Milton, Ontario,
              Canada.
            </p>
            <p
              style={{
            ...
            >
              Made with care. Next.js and Shopify.
            </p>
          </div>
        </div>
      </footer>
