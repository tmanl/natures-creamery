          ...
          <ul className="nav-links" role="list" style={{ display: 'flex', alignItems: 'center', gap: 36, listStyle: 'none', padding: 0 }}>
            {NAV_LINKS.map(([h, l]) => (
              <li key={h}>
                  ...
                  href={h}
                  style={{ fontFamily: 'DM Mono, monospace', fontSize: 11, letterSpacing: '.15em', textTransform: 'uppercase', color: '#1E3A2F', opacity: .75, textDecoration: 'none', transition: 'opacity .2s' }}
            ...
            <Reveal dir="right" delay={150}>
              <div style={{ color: '#F7F2E8' }}>
                ...
                <div role="list" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginTop: 40, padding: 0 }}>
                  {[['🌱', 'Plant-Based and Creamy', 'Never compromise on texture'], ['💪', 'Protein-Enhanced', 'Innovative Burcon blends'], ['🍞', 'Incredibly Versatile', 'Toast, boards, baking and more'], ['📋', 'Clean Label', 'No gums, no additives']].map(([icon, label, sub]) => (
              ...
              <ul style={{ display: 'flex', flexWrap: 'wrap', gap: 32, listStyle: 'none', padding: 0 }} role="list">
                {NAV_LINKS.map(([h, l]) => (
                  <li key={h}>
                      ...
                      href={h}
                      style={{ fontFamily: 'DM Mono, monospace', fontSize: 10, letterSpacing: '.18em', textTransform: 'uppercase', color: 'rgba(247,242,232,.4)', textDecoration: 'none', transition: 'color .2s' }}
