...
const PRODUCTS: Product[] = [
  {
    ...
    tagColor: '#1E3A2F',
    title: 'Classic Mayo',
    subtitle: "Nature's Creamery Mayonnaise",
  ...
  },
  {
    ...
    tagColor: '#8B1A1A',
    title: 'Chipotle Mayo',
    subtitle: "Nature's Creamery Chipotle",
      ...
      <div style={{ padding: '24px 24px 28px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        <p
          style={{
            ...
            letterSpacing: '.15em',
            textTransform: 'uppercase',
            color: hovered ? 'rgba(255,255,255,.5)' : '#B8933A',
            marginBottom: 6,
            transition: 'color .4s',
          }}
        >
          ...
          <div>
            <div
              style={{
                ...
                letterSpacing: '.15em',
                textTransform: 'uppercase',
                color: hovered ? 'rgba(255,255,255,.4)' : 'rgba(30,58,47,.4)',
                marginBottom: 2,
                transition: 'color .4s',
              }}
            >
  ...
  return (
    <div
      style={{
        ...
        boxShadow: hov ? '0 12px 40px rgba(30,58,47,.12)' : '0 2px 12px rgba(0,0,0,.03)',
      }}
    ...
    >
      <div
        ...
        style={{
          ...
          right: 0,
          height: 4,
          background: 'linear-gradient(90deg,#1E3A2F,#B8933A)',
    ...
    <main>
      ...
      <header role="banner">
        ...
        >
          <a
            href="#hero"
            aria-label="Nature's Creamery home"
            style={{ display: 'flex', flexDirection: 'column', gap: 1, textDecoration: 'none' }}
          >
            <span
              style={{
                fontFamily: 'Cormorant Garamond, serif',
          ...
          <ul
            className="nav-links"
            role="list"
            style={{ display: 'flex', alignItems: 'center', gap: 40, listStyle: 'none', padding: 0 }}
          >
            {NAV.map(([h, l]) => (
              <li key={h}>
                <a
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.color = '#1E3A2F'
                  }}
                >
                  {l}
                </a>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="Shop now on Shopify (opens in new tab)"
              style={{
                fontFamily: 'Outfit, sans-serif',
                fontSize: 14,
                fontWeight: 700,
            ...
            {NAV.map(([h, l]) => (
              <a
                ...
                style={{
                  ...
                  fontWeight: 700,
                  color: '#1E3A2F',
                  borderBottom: '1px solid rgba(30,58,47,.12)',
                  paddingBottom: 20,
                  textDecoration: 'none',
                  lineHeight: 1.3,
                }}
      ...
      <div id="content">
        <section
          ...
          style={{
            minHeight: '100svh',
            background: 'linear-gradient(150deg,#F5F0E8 0%,#EAE2D0 50%,#DDD4BB 100%)',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
          <div aria-hidden="true" style={{ position: 'absolute', inset: 0, pointerEvents: 'none', overflow: 'hidden' }}>
            ...
            <div
              style={{
                ...
                right: -50,
                borderRadius: '50%',
                border: '1px solid rgba(184,147,58,.08)',
              }}
            />
            <div
              style={{
            ...
            <div className="hero-center">
              <div
                style={{
                  ...
                  borderRadius: 100,
                  opacity: 0,
                  animation: 'fadeUp .6s .1s cubic-bezier(.16,1,.3,1) forwards',
                }}
              >
                <span
                  style={{
              ...
              >
                Real food.
                <br />
                <em style={{ color: '#B8933A', fontStyle: 'italic' }}>Real creamy.</em>
                <br />
                Real good.
              </h1>
              ...
              >
                Plant-based spreads crafted in Milton, Ontario using Burcon&apos;s breakthrough pea and canola
                protein isolates. No eggs, no gums, no compromise.
              </p>
              ...
              >
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Shop all spreads (opens in new tab)"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 8,
                ...
                <a
                  ...
                  style={{
                    ...
                    alignItems: 'center',
                    gap: 8,
                    border: '2px solid rgba(30,58,47,.3)',
                    color: '#1E3A2F',
                    padding: '16px 32px',
                    fontFamily: 'Outfit, sans-serif',
                    fontSize: 15,
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.background = 'rgba(30,58,47,.06)'
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.borderColor = 'rgba(30,58,47,.3)'
              ...
              <div style={{ position: 'relative', animation: 'floatY 6s ease-in-out infinite' }}>
                <img
                  ...
                  style={{
                    maxHeight: 580,
                    objectFit: 'contain',
                    filter: 'drop-shadow(0 40px 80px rgba(30,58,47,.2))',
                  }}
                />
                <div
                  style={{
                    ...
                    padding: '18px 24px',
                    borderRadius: 6,
                    boxShadow: '0 16px 48px rgba(30,58,47,.3)',
                  }}
                >
                  <div
                    style={{
            ...
            {[
              ...
              <Reveal key={label} delay={i * 70}>
                <div style={{ padding: '52px 40px', borderRight: i < 3 ? '1px solid #E0D8C8' : 'none', textAlign: 'center' }}>
                  ...
                  <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, color: 'rgba(30,58,47,.5)' }}>
                    {sub}
                  </div>
                </div>
              </Reveal>
            ...
            <Reveal>
              <div style={{ marginBottom: 64 }}>
                ...
                >
                  Four spreads.
                  <br />
                  <em style={{ color: '#B8933A', fontStyle: 'italic' }}>Endless possibilities.</em>
                </h2>
                ...
                >
                  Every product is made with Burcon&apos;s innovative protein isolates — the same creamy indulgence you
                  love, with ingredients you can actually pronounce.
                </p>
              </div>
            </Reveal>
            ...
            <Reveal delay={200}>
              <div style={{ textAlign: 'center', marginTop: 48 }}>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="View all products (opens in new tab)"
                  style={{
                    display: 'inline-flex',
                    alignItems: 'center',
                    gap: 8,
          ...
          >
              ...
              <div style={{ position: 'relative' }}>
                <div style={{ padding: 3, background: 'linear-gradient(135deg,#B8933A 0%,rgba(184,147,58,.15) 100%)', borderRadius: 8 }}>
                  <img
                    ...
                    alt="Illustrated farmhouse with sunflowers, pea pods, and botanical vines — the Nature's Creamery brand illustration"
                    style={{ width: '100%', display: 'block', borderRadius: 6, opacity: 0.92 }}
                  />
                </div>
                <div
                  aria-hidden="true"
                  style={{
                    ...
                    width: 80,
                    height: 80,
                    border: '2px solid rgba(184,147,58,.3)',
                    borderRadius: 6,
                  }}
                />
              </div>
            ...
            <Reveal dir="right" delay={150}>
              <div>
                ...
                >
                  Where <em style={{ fontStyle: 'italic', color: '#D4AD59' }}>flavour</em>
                  <br />
                  meets integrity
                </h2>
                ...
                >
                  <p>
                    At Nature&apos;s Creamery, we believe treats should feel good during and after the last spoonful.
                    Our recipes are crafted using plant-based ingredients, clean-label formulations, and protein-powered
                    blends from Burcon NutraScience.
                  </p>
                  <p>
                    Think slow mornings, shared boards, and late-night snacks — all elevated with rich, creamy textures
                ...
                <div role="list" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                  {[
                    ['🌱', 'Plant-Based', 'Never compromise on texture'],
                    ['💪', 'Protein-Enhanced', 'Innovative Burcon blends'],
                    ['🍞', 'Versatile', 'Toast, boards, baking'],
                    ['📋', 'Clean Label', 'No gums or additives'],
                  ].map(([icon, label, sub]) => (
                    <div
                      key={label}
                      role="listitem"
                    ...
                    >
                      <div aria-hidden="true" style={{ fontSize: 22, marginBottom: 10 }}>
                        {icon}
                      </div>
                      <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, fontWeight: 700, color: '#D4AD59', marginBottom: 4 }}>
                        {label}
                      </div>
                      <div style={{ fontFamily: 'Outfit, sans-serif', fontSize: 12, color: 'rgba(255,255,255,.45)' }}>
                        {sub}
                      </div>
                    </div>
                  ))}
          ...
          <div style={{ maxWidth: 1280, margin: '0 auto' }}>
            <Reveal>
              <div style={{ marginBottom: 72 }}>
                ...
                >
                  Burcon NutraScience&apos;s Peazazz C and Puratein C protein isolates give our spreads their legendary
                  creaminess without a single egg or gum.
                </p>
              </div>
            </Reveal>
            ...
            <div className="three-col" style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16 }}>
              {[
                [
                  '01',
                  'Source',
                  "We start with Burcon's pure pea and canola protein isolates — the cleanest plant-based emulsifiers available, harvested responsibly in Canada.",
                ],
                [
                  '02',
                  'Craft',
                  'Our team blends each spread to achieve the exact texture and richness of traditional mayo — without any artificial shortcuts, preservatives, or added sugars.',
                ],
                [
                  '03',
                  'Deliver',
                  'Bottled fresh in Milton, Ontario. Whether 354ml or 4L, every jar is made with the same care, precision, and pride.',
                ],
          ...
          >
            <Reveal>
              <img
                ...
                alt="Nature's Creamery Mayonnaise label featuring farmhouse botanical illustration with sunflowers and Creamy Without Compromise tagline"
                style={{
                  width: '100%',
                  objectFit: 'contain',
                  filter: 'drop-shadow(0 32px 64px rgba(30,58,47,.12))',
            ...
            <Reveal dir="right" delay={150}>
              <div>
                ...
                >
                  The original.
                  <br />
                  <em style={{ fontStyle: 'italic', color: '#B8933A' }}>Perfectly creamy.</em>
                </h2>
                ...
                <ul role="list" aria-label="Product highlights" style={{ display: 'flex', flexDirection: 'column', marginBottom: 40, padding: 0, listStyle: 'none' }}>
                  {[
                    'No eggs, no gums, no artificial additives — just honest ingredients',
                    "Rich, creamy texture powered by Burcon's Peazazz C and Puratein C",
                    'Allergen-friendly, preservative-free, and fully plant-based',
                    'Available in 354ml squeeze bottle, 500ml mason jar, and 4L tub',
                  ].map((t) => (
                    <li
                      key={t}
                      style={{
                ...
                <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Order Classic Mayo (opens in new tab)"
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: 8,
                  ...
                  <a
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      gap: 8,
                      border: '2px solid rgba(30,58,47,.25)',
                      color: '#1E3A2F',
                      padding: '16px 32px',
                      fontFamily: 'Outfit, sans-serif',
                      fontSize: 15,
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.borderColor = '#1E3A2F'
                      e.currentTarget.style.background = 'rgba(30,58,47,.05)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.borderColor = 'rgba(30,58,47,.25)'
                      e.currentTarget.style.background = 'transparent'
                    }}
                  >
                    All Products
          ...
          >
            ...
            <Reveal dir="right" delay={150}>
              {sent ? (
                ...
                >
                  <div aria-hidden="true" style={{ fontSize: 56, marginBottom: 20 }}>
                    ✅
                  </div>
                  <h3
                    style={{
                  ...
                  <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 15, color: 'rgba(255,255,255,.5)' }}>
                ...
                <form onSubmit={submit} noValidate aria-label="Contact form">
                  {[
                    ...
                    <div key={f.id} style={{ marginBottom: 20 }}>
                      ...
                      >
                        {f.label}
                        {f.req && (
                          <span aria-label="required" style={{ color: '#B8933A' }}>
                            {' '}
                            *
                          </span>
                        )}
                      ...
                      <input
                        ...
                        onFocus={(e) => {
                          ...
                          e.currentTarget.style.background = 'rgba(184,147,58,.08)'
                        }}
                        onBlur={(e) => {
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      e.currentTarget.style.background = '#D4AD59'
                      e.currentTarget.style.transform = 'translateY(-1px)'
                    }}
                    onMouseLeave={(e) => {
                      e.currentTarget.style.background = '#B8933A'
        ...
        <div style={{ maxWidth: 1280, margin: '0 auto' }}>
          ...
          >
            <div style={{ maxWidth: 280 }}>
              ...
              <p style={{ fontFamily: 'Outfit, sans-serif', fontSize: 13, color: 'rgba(255,255,255,.4)', lineHeight: 1.7 }}>
                Plant-based spreads crafted with care in Milton, Ontario, Canada.
              </p>
            </div>
            ...
            <div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Shop all products (opens in new tab)"
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: 8,
          ...
          >
            ...
            <p style={{ fontFamily: 'DM Mono, monospace', fontSize: 11, color: 'rgba(255,255,255,.15)' }}>
